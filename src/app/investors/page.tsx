...
export const metadata: Metadata = {
  ...
  description:
    "Hemco Group is a privately held industrial group from India. Investor relations, strategic partnerships, and alliance enquiries for the group and its eleven operating brands.",
