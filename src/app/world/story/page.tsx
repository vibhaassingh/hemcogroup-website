...
export const metadata: Metadata = {
  title: "Our story",
  description:
    "Twenty-eight years from a single workshop in India to a house of thirteen brands across seven sectors. The history of Hemco Group, founded in 1998.",
  alternates: { canonical: "/world/story" },
  openGraph: {
    title: "Our story · Hemco Group",
    description:
      "Twenty-eight years from a single workshop in India to a house of thirteen brands across seven sectors.",
    url: "/world/story",
    type: "article",
  },
  twitter: {
    ...
    title: "Our story · Hemco Group",
    description: "From a single workshop in India to a house of thirteen brands.",
  },
};
...
const eras = [
  ...
  },
  {
    numeral: "V",
    range: "2026 →",
    title: "Thirteen brands, seven sectors.",
        ...
        <div className="max-w-5xl">
          ...
          <Reveal delay={0.5}>
            ...
            >
              ...
              of thirteen brands across seven sectors — written in our own
              words, in five eras.
            </p>
          </Reveal>
        </div>
      ...
      <Section tone="ivory" pad="xl">
        <div className="grid gap-12 md:grid-cols-12 items-start">
          ...
          <div className="md:col-span-7 md:col-start-6">
            ...
            >
              The answer is the rest of this page. Five eras, thirteen brands,
