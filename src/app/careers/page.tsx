...
export const metadata: Metadata = {
  title: "Careers",
  description:
    "Build with Hemco Group across eleven operating brands and seven sectors. Open roles, the working culture, and how to apply at hemco.ooo, kerningai.eu, studio.kerning.ooo and more.",
  alternates: { canonical: "/careers" },
  openGraph: {
    title: "Careers · Hemco Group",
    description: "Build with us, across eleven brands.",
    url: "/careers",
    type: "website",
  },
  twitter: {
